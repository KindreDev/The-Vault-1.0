...
const LEVEL_TITLES = [
  { level: 1,  title: 'Lurker' },
  { level: 6,  title: 'Wanderer' },
  { level: 11, title: 'Seeker' },
  { level: 16, title: 'Delver' },
  { level: 21, title: 'Collector' },
  { level: 26, title: 'Acolyte' },
  { level: 31, title: 'Devotee' },
  { level: 36, title: 'Archivist' },
  { level: 41, title: 'Disciple' },
  { level: 46, title: 'Connoisseur' },
  { level: 51, title: 'Curator' },
  { level: 56, title: 'Zealot' },
  { level: 61, title: 'Degenerate' },
  { level: 66, title: 'Gooner' },
  { level: 71, title: 'Sovereign' },
  { level: 76, title: 'Corruptor' },
  { level: 81, title: 'Obsessed' },
  { level: 86, title: 'Legendary Collector' },
  { level: 91, title: 'Transcendent Hoarder' },
