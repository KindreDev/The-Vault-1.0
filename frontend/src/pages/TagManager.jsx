...
const CATS = [
  ...
  { key: 'clothing',         label: 'Clothing',            color: 'var(--c-green)' },
  { key: 'physical_feature', label: 'Physical Appearance', color: '#378ADD' },
  { key: 'sex_act',          label: 'Sex Act',             color: 'var(--c-pink)' },
  { key: 'nudity_level',     label: 'Nudity',              color: 'var(--c-amber)' },
  { key: 'position',         label: 'Position',            color: '#9B59B6' },
  { key: 'pose',             label: 'Pose',                color: '#6B7280' },
  { key: 'rating',           label: 'Rating',              color: '#9CA3AF' },
  { key: 'character',        label: 'Character',           color: 'var(--c-accent)' },
