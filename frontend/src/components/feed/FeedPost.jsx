        ...
        {comments.length > 0 && (
          <div className="mt-2 flex flex-col gap-1">
            ...
            {visibleComments.map(cm => (
              <div key={cm.id} className="text-[15px] leading-snug" style={{ color: 'rgba(255,255,255,0.75)' }}>
                <span
                  className={`font-semibold ${cm.is_erika ? '' : 'cursor-pointer'}`}
                  style={{ color: cm.is_erika ? '#CE93F8' : 'rgba(255,255,255,0.92)' }}
